# Based on tin.py:
# https://github.com/qtile/qtile-examples/blob/master/user-configs/tin.py
...
keys = [
    ...
    # PRINT SCREEN
    Key([sup], "F10", lazy.spawn("import -window root ~/Pictures/Screenshots/screenshot.png")),
